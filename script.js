...
for (let i = 0; i < 7; i++) {
    array_img.push({ key: i + 1, url: `./assests/circle/c${i+1}.jpg`});
...
let gallery_img = [{ key: 1, url: "./assests/bg.jpg" }];
for (let i = 0; i < numberOfImages; i++) {
  gallery_img.push({
    key: i + 1,
    url: `./assests/gallery/p${numm[i]}.jpg`,
  });
}
...
// });
  ...
  //   let count = 0
  //   if(numm[i] === gallery_img[count].key){
  //     new_num.push(gallery_img[count])
  //   }
  //   while( numm[i] != gallery_img[count].key){
  //     count++
  //     if(numm[i] === gallery_img[count].key){
  //     new_num.push(gallery_img[count])
  //     break
